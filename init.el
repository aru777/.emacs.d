...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-plus-contrib diminish smex evil-surround auto-yasnippet keyfreq rainbow-delimiters projectile company-irony counsel swiper ivy company evil org-bullets yasnippet-snippets yasnippet spaceline solarized-theme ace-window thrift super-save which-key use-package))))
